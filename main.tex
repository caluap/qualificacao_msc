...
Ao final da exibição, pediremos aos participantes que preencham um questionário de auto-avaliação. Este será composto de questões de escala Likert que, adaptadas do questionário apresentado em \citet{Kruger2016}, decomporão \textit{imersão} em alguns sub-componentes: \textit{transporte},\sidenote[][-3\baselineskip]{Qualidade de um espectador se perceber transportado para uma realidade fictícia, com consequente suspensão de seu foco na realidade externa imediata.} \textit{identificação com as personagens}\sidenote{Afinidade que o espectador cria com as personagens, equivalendo a um entendimento empático de seus sentimentos, desafios etc.} e \textit{realismo percebido}\sidenote{Senso de quão plausível se faz perceber uma obra, ou seja, se ela apresenta consistência narrativa de acordo com as expectativas que o espectador traz consigo.}.
