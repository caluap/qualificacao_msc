...
Até que fossem introduzidos em monastérios cristãos medievais, não havia espaços separando as palavras, levando alguns historiadores a avançar a teoria\sidenote[][\baselineskip]{Popular, mas um tanto controversa. Ver \citet{McCutcheon2015}.} que a literatura na antiguidade era predominantemente acústica \citep{kuster2016}: um texto, quando lido, o era em voz alta. A forma como se dava essa leitura -- onde eram colocadas as ênfases, silêncios, diferenças de entonação etc -- dependia em grande parte de convenções de declamação. Tratava-se de um texto ``melhor percebido pelos ouvidos do que pelos olhos.'' \citep{nunlist1991}
