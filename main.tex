...
\newcommand\ytl[2]{
\parbox[b]{8em}{\hfill{\bfseries #1}~$\cdots\cdots$~}\makebox[0pt][c]{$\bullet$}\vrule\quad \parbox[c]{4.5cm}{\vspace{7pt}\raggedright #2.\\[7pt]}\\[-3pt]}


\begin{table}
\centering
% \begin{minipage}[t]{.7\linewidth}
\ytl{jan}{Comeu repolho}
\ytl{fev}{Comeu abobrinha}
\ytl{mar}{Comeu frango frito}
% \end{minipage}%
\end{table}
