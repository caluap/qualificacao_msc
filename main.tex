...
% Considering this, we adopted suprasegmental, unidimensional, prosodic features as good estimators of expressive speech dynamics\cite{rao2010characterization}. In particular, we evaluated {\itshape root mean square} (\textsc{rms}), scaling intensity, and {\itshape fundamental frequency} ($f_0$), scaling pitch, both windowed at each syllable.
