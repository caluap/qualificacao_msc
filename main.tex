...
Visamos criar um modelo de mapeamento prosódia---tipografia aplicável a sistemas de legendagem e que torne mais imersivo o consumo de conteúdos audiovisuais. Descreveremos a seguir nossa abordagem para criação desse modelo e, na sequência, os três experimentos (dois dos quais já realizados) que visam investigar \num{1} quão consistentemente respondem leitores a essa tipografia modulada pela fala, \num{2} quais \textit{features} prosódicas melhor se relacionam a quais eixos tipográficos e em quais situações e, finalmente, \num{3} se o uso de legendas moduladas pela voz produz uma experiência subjetiva mais rica.
