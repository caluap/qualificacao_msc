...
Ao contrário dos outros dois, o terceiro experimento não foi executado até o momento em que escrevemos, sendo planejado como a última etapa do projeto de mestrado. Apesar de acreditarmos que estudos futuros devam explorar inúmeras áreas que tocamos mas não aprofundamos -- entre elas, melhor modelo de extração de prosódia; novos eixos tipográficos, inclusive eventuais eixos especificamente criados tendo em vista a representação prosódica; comportamento do modelo quando usado com áudios gerados 
